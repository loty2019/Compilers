...
class JMultiplyOp extends JBinaryExpression {
     ...
     *
     * @param line line in which the #tion expression occurs in the source file.
     * @param lhs  the lhs operand.
     * @param rhs  the rhs operand.
     */
    ...
    public JExpression analyze(Context context) {
        ...
        if (lhs.type() == Type.INT && rhs.type() == Type.INT) {
            ...
            JAST.compilationUnit.reportSemanticError(line(), "Operands must be of the same type (int, long, or double)");
            type = Type.INT;
        }
        return this;
    }
